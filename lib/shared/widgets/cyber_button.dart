...
class CyberButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final background =
        tone == CyberButtonTone.ghost ? Colors.transparent : color;
    final foreground =
        tone == CyberButtonTone.ghost ? Colors.white : Colors.black;
    final child = FilledButton.icon(
      ...
      style: FilledButton.styleFrom(
        ...
        side: tone == CyberButtonTone.ghost
            ? BorderSide(color: Colors.white.withOpacity(.24))
            : null,
